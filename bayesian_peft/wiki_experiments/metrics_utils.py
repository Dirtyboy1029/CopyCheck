...
def compute_variance(pt_samples):
    ...
    return aleatoric_uncertainty[0][0], epistemic_uncertainty[1][1]

def predictive_entropy(p, base=2, eps=1e-10, number=5):
    """
...
def predictive_kld(p, number=5, w=None, base=2, eps=1e-10):
    """
...
def predictive_std(p, number=5, w=None):
    """
